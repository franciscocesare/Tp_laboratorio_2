...
{
    /// <summary>
    /// No podrá tener clases heredadas. Sealed
    /// </summary>
    public sealed class Estacionamiento
    {
        ...
        public Estacionamiento(int espacioDisponible) : this()  //pa que me llame al que tiene la list
        {
        ...
        public static string Mostrar(Estacionamiento c, ETipo tipo)
        {
            ...
            //arreglar las condiciones se me ven todos
        ...
        {
            foreach (Vehiculo v in c.vehiculos)  ///aca me llega NULL
            {
                if (v == p)
                    return c;
            }
